    ...
    <div className="animate-fade-in">
      ...
      <Section id="about" title="About Nubia">
        <div className="nubia-prose">
          ...
          <div className="mt-6 p-4 border-l-2 border-nubia-accent bg-gradient-to-r from-nubia-surface-alt to-transparent">
      ...
      <footer className="mt-20 pt-12 border-t border-nubia-border">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-nubia-text-muted mb-4">
