    ...
    <div className="py-8 px-4 md:px-6 max-w-4xl mx-auto">
      ...
      <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-sans font-semibold text-amber-800 dark:text-amber-300 mb-1">Limitations</h3>
            <ul className="text-sm text-amber-700 dark:text-amber-200/90 space-y-1">
